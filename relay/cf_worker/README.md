...
`z2r_autobench`) то же самое — пункт 14 → 3 → 3 "WhatsApp REDIRECT" (был
пункт 22, потом 31, см. z2r_autobench/CLAUDE.md для полной истории
перенумерации).
...
нужен только web.telegram.org. `z0r` пункт 14 → 3 → 4/5 переключает их
